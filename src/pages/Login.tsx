...
export const Login:React.FC = () => {
  ...
  return (
    ...
    '>
      <img className='hidden lg:block aspect-[6/7]' loading='lazy' src="/img/login-family-d.webp" alt="Familia" />
      <div className='lg:max-w-[400px]'>
        ...
        '>
          ...
          <img className='lg:hidden aspect-[17/20]' loading='lazy' src="/img/login-family-m.webp" alt="Familia" />
        </div>
